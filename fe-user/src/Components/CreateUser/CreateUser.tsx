...
import { API_CREATE_USER, MAX_LENGTH } from "../../constant.type";
...
export default function CreateUser() {
  ...
  const handleUser = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      let registerUser = await axios.post(API_CREATE_USER, formData);
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  name="firstName"
                  error={firstName.length > MAX_LENGTH}
                  required
                  fullWidth
                  id="firstName"
                  label="First Name"
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  fullWidth
                  id="lastName"
                  error={lastName.length > MAX_LENGTH}
                  label="Last Name"
                  name="lastName"
                  value={lastName}
